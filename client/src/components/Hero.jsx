...
const Hero = () => {
  ...
  return (
    <div className='container 2xl:px-20 mx-auto  my-10'>
        <div className='bg-gradient-to-r to-purple-600 from-blue-600 text-white py-16 text-center mx-2 rounded-xl'>
            ...
            <div className='flex items-center flex-row justify-between bg-white rounded text-gray-600 max-w-xl pl-4 mx-4 sm:mx-auto'>
